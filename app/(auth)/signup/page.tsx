...
// 1. मुख्य फॉर्म लॉजिक को अलग कंपोनेंट में रखा ताकि Suspense काम कर सके
...
// 2. मुख्य एक्सपोर्ट जिसे Suspense बाउंड्री के अंदर रैप किया गया है
export default function SignupPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white flex flex-col">
      <Header />
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <Suspense fallback={<div className="text-center text-gray-500 p-4">Loading signup form...</div>}>
          <SignupFormContent />
        </Suspense>
      </main>
      <Footer />
